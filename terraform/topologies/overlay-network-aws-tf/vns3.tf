...
module "vns3_vpc1" {
  ...
  subnet_ids          = length(module.aws_vpc1.subnet_ids) == 0 ? [] : slice(module.aws_vpc1.subnet_ids, 0, 1)
...
module "vns3_vpc2" {
  ...
  subnet_ids          = length(module.aws_vpc2.subnet_ids) == 0 ? [] : slice(module.aws_vpc2.subnet_ids, 0, 1)
  common_tags         = var.common_tags
}
